...
const userSchema = new Schema({
    userName: { type: String, required: true, minLength: 3, maxLength: 60, match: [/^[a-zA-Z]+$/, 'El nombre de usuario solo puede contener caracteres alfabéticos'] 
    },
    userEmail: { type: String, required: true, match: [ /.+@.+\..+/, "Caracteres invalidos" ], minLength: 3, maxLength: 60 },
